...
import { events, shadowActivities, dungeons } from "./data";
...
function App() {
  return (
    <div className="flex bg-gray-800 h-screen">
      ...
      <div className="flex flex-col justify-between bg-gradient-to-br from-immortal-brown to-gray-600 scroll-smooth">
        <div className="flex flex-col font-immortal">
          <div className="py-4 bg-immortal-dark flex pl-4 items-center justify-between">
            <span className="text-white text-3xl flex space-x-4">
              <img
                height={30}
                width={30}
                src={process.env.PUBLIC_URL + "diablo-icon.png"}
              />
              <span>Immortal Activities</span>
            </span>
          ...
          <div className="flex flex-col space-y-4 pl-4 py-8 text-xl">
            ...
            <p>
              Select a category below to see events in that category. Some
              events have links to relevant sites with more info on drops,
              strats, suggested builds etc.
            </p>
            <p>
              ...
              fugiat voluptate eiusmod magna dolor sit ut culpa nisi sit minim
              qui aliqua veniam. Ullamco ullamco aute veniam mollit ut sit.
              Tempor anim adipisicing officia ad tempor.
            </p>
          </div>
          <div className="">
            <Accordion allowToggle className="bg-gray-600 text-white">
              <ActivityPanel title="Zone Events" items={events} />
              <ActivityPanel title="Dungeons" items={dungeons} />
              <ActivityPanel
                isDisabled
                title="Zone Bosses"
                items={shadowActivities}
              />
              <ActivityPanel
                isDisabled
                title="Shadow Activities"
                items={shadowActivities}
              />
              <ActivityPanel
                isDisabled
                title="Immortal Activities"
                items={events}
              />
            </Accordion>
          </div>
